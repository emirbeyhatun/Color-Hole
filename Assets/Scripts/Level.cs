...
public class Level : MonoBehaviour
{
	...
	//[HideInInspector] public int secondPartObjects;
	//total objects at the beginning
	[HideInInspector] public int totalObjects;

	//the Objects parent
	[SerializeField] Transform objectsParentFirst;
	[SerializeField] Transform objectsParentSecond;
	...
	void CountObjects ()
	{
		...
		//secondPartObjects = objectsParentSecond.childCount;
		totalObjects = objectsParentFirst.childCount/* + objectsParentSecond.childCount*/;
